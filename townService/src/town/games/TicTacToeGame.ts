...
export default class TicTacToeGame extends Game<TicTacToeGameState, TicTacToeMove> {
  ...
  private _validateMove(move: TicTacToeMove, checkTurn = true) {
   ...
   */
  public applyMove(move: GameMove<TicTacToeMove>, checkTurn = true): void {
    let gamePiece: 'X' | 'O';
    ...
    this._validateMove(cleanMove, checkTurn);
